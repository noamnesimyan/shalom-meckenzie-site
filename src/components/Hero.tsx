...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Postcards Container */}
        <div className="relative w-full h-[540px] md:h-[520px] mx-auto max-w-[360px] md:max-w-none">
          {/* Card A: The invitation postcard */}
          <motion.div
            variants={fadeUp}
            className={`absolute left-0 top-[40px] md:top-0 z-20 w-[85%] md:w-[460px] shadow-2xl ${reduce ? "" : "float-a"}`}
          >
          ...
          <motion.div
            variants={fadeUp}
            className={`absolute right-0 top-[150px] md:top-[60px] z-10 w-[65%] md:w-[360px] shadow-2xl ${reduce ? "" : "float-b"}`}
          >
